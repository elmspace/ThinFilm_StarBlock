  ...
  if(Round==1){
	...
	for(j=0;j<Ny;j++){
	  for(k=0;k<Nz;k++){
	    ...
	    w[0][i][j][k]=-0.1*(drand48()-0.50); //A1
	    w[1][i][j][k]=-0.1*(drand48()-0.50); //A2
	    w[2][i][j][k]=-0.1*(drand48()-0.50); //A3
	    w[3][i][j][k]=-0.1*(drand48()-0.50); //A4
	    w[4][i][j][k]=-0.1*(drand48()-0.50); //B1
	    w[5][i][j][k]=-0.1*(drand48()-0.50); //B2
	    w[6][i][j][k]=-0.1*(drand48()-0.50); //B3
	    w[7][i][j][k]=-0.1*(drand48()-0.50); //B4
