...
path."Lam_1Arm.dat" using ($1-$2):($3-$4)  title "1Arm" with linespoints lt 1 pt 2 lw 4,\
   path."Lam_2Arm.dat" using ($1-$2):($3-$4)  title "2Arm" with linespoints lt 2 pt 4 lw 4,\
       path."Lam_3Arm.dat" using ($1-$2):($3-$4)  title "3Arm" with linespoints lt 3 pt 6 lw 4,\
	  path."Lam_4Arm.dat" using ($1-$2):($3-$4)  title "4Arm" with linespoints lt 4 pt 8 lw 4
